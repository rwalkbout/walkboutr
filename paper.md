...
![Table 1. Processed accelerometry data.\label{table:1}](table1.png){width=125%}
...
![Table 2. Processed GPS data.\label{table:2}](table2.png){width=125%}
...
![Table 3. Parameters.\label{table:3}](table3.png){width=125%}

The constants can be found in Table 4.  

![Table 4. Constants.\label{table:4}](table4.png){width=125%}
...
![Table 5. Full dataset.\label{table:5}](table5.png){width=125%}

![Table 6. Summarized dataset.\label{table:6}](table6.png){width=125%}
...
![Table 6. Example of a walk bout.\label{fig:5}](fig_5.png){width=125%}
